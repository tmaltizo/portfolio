...
export default function PostPage({ post, mdxSource }) {
  ...
  return (
    <>
      ...
      <main className="bg-light-bg dark:bg-dark-bg min-h-screen mr-10 sm:mr-12 px-4 md:px-8 py-12 overflow-x-hidden">
        <div className="max-w-3xl mx-auto pl-10 sm:pl-8">
        {/* Back link */}
        <Link
          href="/writing"
